...
pub struct InitNutritionistNft<'info> {
    ...
    #[account(
        ...
        payer = payer,
        mint::decimals = 0,
        mint::authority = nutritionist_nft_mint.key(),
        mint::freeze_authority = nutritionist_nft_mint.key(),
    ...
    #[account(
        mut,
        address=find_metadata_account(&nutritionist_nft_mint.key()).0
    )]
    ...
    create_metadata_accounts_v3(
        CpiContext::new(
            ...
            CreateMetadataAccountsV3 {
                ...
                mint_authority: ctx.accounts.nutritionist_nft_mint.to_account_info(), // PDA is mint authority
                update_authority: ctx.accounts.nutritionist_nft_mint.to_account_info(), // PDA is update authority
