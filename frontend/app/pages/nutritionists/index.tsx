...
import { useCreateAppointmentMutation } from "@/state/services";
import { NewAppointment, Nutritionist } from "@/state/types";
import {
  useToast,
  Avatar,
  Box,
                  ...
                  >
                    <Flex wrap={"wrap"} align={"start"} gap={4} mb={5}>
                      ...
                      <Button
                        ...
                        size={"md"}
                      >
                        <HiOutlineBookOpen size={24} name="book" /> Book an
                        Appointment
                      </Button>
                    </Flex>
                    <Box>
                      ...
                      {sectionTimes.map((dur, i) => {
                        return (
                          <Button
                            ...
                            color={
                              sectionDuration === dur ? "gs-yellow.900" : ""
                            }
