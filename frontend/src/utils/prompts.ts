...
export const initial_condition = `
    ...
    You must respond with the following either of the following (Reverse, Fast, Moderate, Slow) as a JSON object,
    example: {"aging": "Fast" // or any of this (Reverse, Fast, Moderate, Slow)}

    The output will depend on the input data provided.
    An input data is a string in this format \n
    Date of Birth: value
    Sex: value
    Weight: value
    Height: value
    ...
    Hours Sitting Per Day: value
    Alcohol Rate: value
    Smoking: value
    Sleep Per Day: value
    Overall Health Rating: value
